...
<body>
    ...
    <a href="04RequestWebInfo.jsp?eng=Hello&han=안녕">  <!--GET 방식으로 요청-->
      GET 방식 전송
    </a>
    <br />
    <form action="04RequestWebInfo.jsp" method="post">  <!--POST 방식으로 요청-->
    ...
    <form method="post" action="04RequestParameter.jsp">  <!--다양한 <input> 태그 사용-->
